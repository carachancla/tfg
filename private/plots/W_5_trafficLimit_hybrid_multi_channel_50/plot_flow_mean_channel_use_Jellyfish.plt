...
plot    "data_W_1_trafficLimit_hybrid_mean_channel_use.txt" using ($2*flow_size):(stringcolumn(1) eq "jellyfish_n128_d30_hybrid_cableLength_7" ? ($3*100): 1/0) title "402 wireless ports" smooth unique w lp ls 3, \
