...
plot    "../W_1_trafficLimit_hybrid/data_W_1_trafficLimit_hybrid_mean_channel_use.txt" using ($2*flow_size):(stringcolumn(1) eq "jellyfish_n128_d30_ethernet" ? $3: 1/0) title "no wireless" smooth unique w lp ls 2, \
        "data_W_1_trafficLimit_hybrid_mean_channel_use.txt" using ($2*flow_size):(stringcolumn(1) eq "jellyfish_n128_d30_hybrid_cableLength_5" ? $3: 1/0) title "1409 wireless ports" smooth unique w lp ls 1, \
        ...
        "data_W_1_trafficLimit_hybrid_mean_channel_use.txt" using ($2*flow_size):(stringcolumn(1) eq "jellyfish_n128_d30_hybrid_cableLength_15" ? $3: 1/0) title "25 wireless ports" smooth unique w lp ls 6
