...
plot    "data_W_0_oneToOneTrafficLimit_mean_channel_use.txt" using 2:(stringcolumn(1) eq "non-persistent" ? $3: 1/0) title "non-persistent" smooth unique w lp ls 2, \
        "data_W_0_oneToOneTrafficLimit_mean_channel_use.txt" using 2:(stringcolumn(1) eq "1-persistent" ? $3: 1/0) title "1-persistent" smooth unique w lp ls 1
