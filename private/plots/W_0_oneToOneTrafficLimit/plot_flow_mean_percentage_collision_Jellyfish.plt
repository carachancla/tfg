...
plot    "data_W_0_oneToOneTrafficLimit_percentage_collision.txt" using 2:(stringcolumn(1) eq "non-persistent" ? $3: 1/0) title "non-persistent" smooth unique w lp ls 2
