...
properties_file=private/runs/W_3_trafficLimit_hybrid_high_speed/jellyfish_n128_d30_hybrid.properties
run_folder=W_3_trafficLimit_hybrid_high_speed/jellyfish_n128_d30_hybrid
