...
public class WirelessTest
{
    public static void main(String[] args){
        ...
        wirelessPortGen = new WirelessPortGen(1000,1000);
        wp1 = (WirelessPort) wirelessPortGen.generate(forwarderSwitch1,forwarderSwitch2, new WirelessLink(10, 100));
        wp2 = (WirelessPort) wirelessPortGen.generate(forwarderSwitch2, forwarderSwitch1, new WirelessLink(10, 100));
